    ...
    return {
      ...
      currentUser:
       localStorage.getItem("user-name"),
        // this.$route.query.userName || localStorage.getItem("loggedInUserName"),
      matchedUsers: [],
    };
  },
  computed: {
    filteredUsers() {
      return this.matchedUsers.filter(
  ...
  methods: {
    async fetchMatches() {
      try {
        ...
        // Filter matches based on the current user's participation and map to the other user in the match
